...
from settings import flags, google, _client, source_bucket_endpoint
from functions import configure_logger, authorize_google, get_sheet_data, process_dataframe, \
    copy_input, set_google_sheets, get_sheet_id, list_client_directories, write_sheet_data
...
if __name__ == "__main__":
    ...
    sheet_config = set_google_sheets(input_name='ramachandran', **google)
